...
const Sidebar = () => {
  ...
  //   const loading = false;
  //     const matches = [{ _id: 1, name: "Jane Doe" }];
    ...
    <>
      ...
      >
        <div className="flex flex-col h-full">
          {/* sidebar header */}
          <div className="p-4 pb-7 border-b border-pink-200 flex justify-between items-center">
            ...
            {isLoadingMyMatches ? (
              ...
              matches.map((match) => (
                <Link key={match._id} to={`/chat/${match._id}`}>
                  <div className="flex items-center mb-4 cursor-pointer hover:bg-pink-50 p-2 rounded-lg transition-all duration-300">
                    <img
  ...
  return (
    <div className="flex flex-col items-center justify-center text-center h-full">
      ...
      <p className="text-gray-500 max-w-xs ">
        We are finding your prefetch matches. This may take a few seconds...
      </p>
    </div>
  );
};
